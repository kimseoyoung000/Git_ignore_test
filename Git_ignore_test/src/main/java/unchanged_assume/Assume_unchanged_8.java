...
public class Assume_unchanged_8 {
	...
	*/
		...
		System.out.println("==== Assume_unchanged_8.java 파일을 수정했어요. ===="); 
		System.out.println("==== Assume_unchanged_8.java 파일을 또 수정했어요. ===="); 
		System.out.println("==== Assume_unchanged_8.java 파일을 완성했어요. ===="); 
	}
